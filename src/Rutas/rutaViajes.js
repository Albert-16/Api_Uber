...
router.get('/obtenerTotalViajes',controladorSesiones.validarAutenticado, controladorViaje.totalViajes);
router.post('/guardar',controladorSesiones.validarAutenticado,
    ...
    body('latitud_Inicial').isDecimal().withMessage('Es necesario ingresar una latitud inicial'),
    body('longitud_Inicial').isDecimal().withMessage('Es necesario ingresar una longitud inicial'),
    body('latitud_Final').isDecimal().withMessage('Es necesario ingresar una latitud final'),
    body('longitud_Final').isDecimal().withMessage('Es necesario ingresar una longitud final'),
